...
struct ClientSessionInfo_t2387  : public Object_t
{
	...
	ByteU5BU5D_t13* ___sid_4;
	// System.Byte[] Mono.Security.Protocol.Tls.ClientSessionInfo::masterSecret
	ByteU5BU5D_t13* ___masterSecret_5;
};
struct ClientSessionInfo_t2387_StaticFields{
