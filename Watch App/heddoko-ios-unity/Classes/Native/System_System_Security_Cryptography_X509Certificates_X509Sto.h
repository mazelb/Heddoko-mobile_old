...
struct X509Store_t681  : public Object_t
{
	...
	X509Certificate2Collection_t671 * ___list_2;
...
struct X509Store_t681_StaticFields{
	...
	Dictionary_2_t9 * ___U3CU3Ef__switch$mapF_5;
};
