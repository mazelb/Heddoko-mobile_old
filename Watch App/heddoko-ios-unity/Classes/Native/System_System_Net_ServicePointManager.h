...
struct ServicePointManager_t648  : public Object_t
{
};
struct ServicePointManager_t648_StaticFields{
	// System.Collections.Specialized.HybridDictionary System.Net.ServicePointManager::servicePoints
	HybridDictionary_t601 * ___servicePoints_0;
	...
	RemoteCertificateValidationCallback_t632 * ___server_cert_cb_9;
};
