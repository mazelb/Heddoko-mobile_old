...
struct ExtendedKeyUsageExtension_t2362  : public X509Extension_t683
{
	// System.Collections.ArrayList Mono.Security.X509.Extensions.ExtendedKeyUsageExtension::keyPurpose
	ArrayList_t610 * ___keyPurpose_3;
};
struct ExtendedKeyUsageExtension_t2362_StaticFields{
	...
	Dictionary_2_t9 * ___U3CU3Ef__switch$map14_4;
};
