...
struct SimpleCollator_t1302  : public Object_t
{
	...
	CodePointIndexer_t1287 * ___cjkIndexer_6;
	...
	CodePointIndexer_t1287 * ___cjkLv2Indexer_8;
...
struct SimpleCollator_t1302_StaticFields{
	...
	SimpleCollator_t1302 * ___invariant_1;
};
