...
struct CanvasListPool_t467  : public Object_t
{
};
struct CanvasListPool_t467_StaticFields{
	...
	ObjectPool_1_t465 * ___s_CanvasListPool_0;
	...
	UnityAction_1_t466 * ___U3CU3Ef__am$cache1_1;
};
