...
struct ComponentListPool_t471  : public Object_t
{
};
struct ComponentListPool_t471_StaticFields{
	...
	ObjectPool_1_t469 * ___s_ComponentListPool_0;
	...
	UnityAction_1_t470 * ___U3CU3Ef__am$cache1_1;
};
