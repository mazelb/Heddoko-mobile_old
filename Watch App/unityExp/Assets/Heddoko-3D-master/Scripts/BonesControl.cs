...
public class BonesControl : MonoBehaviour 
{
	...
	void Start () 
	{
		...
		else 
		{
			...
			*/
			...
			//nc.setSensorNames("nod-25d","nod-45a","nod-2cd","nod-55c","nod-1f2","nod-3fc","nod-274","nod-27c","nod-2cb","nod-421");
			//nc.setSensorNames("nod-25d","nod-45a","nod-2cd","nod-55c","nod-42b","nod-3fc","nod-274","nod-27c","nod-2cb","nod-421");
			//nc.setSensorNames("nod-25d","nod-425","nod-2cd","nod-55c","nod-47a","nod-3fc","nod-274","nod-27c","nod-2cb","nod-421");
			//nc.setSensorNames("nod-25d","nod-425","nod-2cd","nod-55c","nod-428","nod-3fc","nod-274","nod-27c","nod-2cb","nod-421");
			//nc.setSensorNames("nod-25d","nod-425","nod-2cd","nod-55c","nod-380","nod-3fc","nod-274","nod-27c","nod-2cb","nod-421");
			//nc.setSensorNames("nod-9d8","nod-9fc","nod-a37","nod-a8f","nod-a16","nod-a0c","nod-96d","nod-9de","nod-a35","nod-92d");

			nc.realTimeTracking = true;
			nc.playRecording = false;
			nc.dummyMode = false;

			nc.setSensorNames("nod-9d8","nod-9fc","nod-55d","nod-55c","nod-a16","nod-a0c","nod-96d","nod-9de","nod-a35","nod-92d");
	...
	void OnGUI()
	{
		...
		/*    
		if (GUI.Button (new Rect (320, 720, 300, 100), "Play Reference"))
        {
